...
/*! lanaiui.js
* ================
* Main JS application file for Lanai v2. This file
* should be included in all pages. It controls some layout
* options and implements exclusive Lanai plugins.
*/
...
+function ($) {
    ...
    $(document).on('click', ChatOnline.chatlisten, function () {
...
+function ($) {
    ...
    //刷新当前页
    $(document).on('click', tooltips.refresh, function () {
    ...
    //全屏
    $(document).on('click', tooltips.fullscreen, function () {
        screenfull.toggle();
    });
    //锁定
    $(document).on('click', tooltips.lock, function (e) {
    ...
    $(document).on('click', tooltips.unlock, function (e) {
        /*
           functions
        */
        $.modal.close(); 
...
+function ($) {
    ...
    $.addtabs.add = function (opts) {
        ...
        if (opts.content) {
            ...
            //没有内容，使用IFRAME打开链接   
            //var iframe = $('<iframe class="iframeClass" height="' + settings.iframeHeight() + '" frameborder="no" border="0" src="' + opts.url + '"  seamless>');
